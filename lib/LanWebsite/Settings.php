    ...
    class LanWebsite_Settings {
        ...
        function __construct() {
            $this->defaults = array(
                ...
                "lan_capacity" => array("int", "50", SettingsGroup::Lan),
                ...
                "paypal_email" => array("email", "paypal@" . SITE_HOST, SettingsGroup::PayPal),
                "paypal_return_url" => array("url", SITE_URL . "/index.php?page=tickets&action=complete", SettingsGroup::PayPal),
                "paypal_ipn_url" => array("url", SITE_URL . "/index.php?page=tickets&action=ipn", SettingsGroup::PayPal),
                "paypal_url" => array("url", "https://www.paypal.com/cgi-bin/webscr", SettingsGroup::PayPal),
                "site_email_error" => array("email", "webmaster@" . SITE_HOST, SettingsGroup::Email),
                "site_email_contact" => array("email", "contact@" . SITE_HOST, SettingsGroup::Email),
                "email_user" => array("email", "noreply@" . SITE_HOST, SettingsGroup::Email),
                ...
                "twitter_username" => array("text", "", SettingsGroup::General),
                "facebook_username" => array("text", "", SettingsGroup::General),
                ...
                "map_process_url" => array("url", SITE_URL . "/map/processseat/?ticket=", SettingsGroup::Map),
                ...
                "chat_url" => array("text", "ws://" . SITE_HOST . ":8087", SettingsGroup::Chat),
                ...
                "lobby_url" => array("text", "ws://" . SITE_HOST . "8088", SettingsGroup::Lobbies),
