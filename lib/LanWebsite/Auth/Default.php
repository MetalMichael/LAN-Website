<?php
	...
	class LanWebsite_Auth_Default implements LanWebsite_Auth {
		...
		public function login($username, $password) {
            ...
            setcookie('lan_session', $this->sessionId, $expires, '/', $config['cookie']['hostname']);
		...
		public function validateCredentials($username, $password) {
			return LanWebsite_Main::getUserManager()->authenticate($username, $password);
		}
